USE [AppsLCA]
GO
/****** Object:  StoredProcedure [dbo].[SP_Transfer_TablaKelly]    Script Date: 16/02/2026 07:40:50 a. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN	
    ...
    DROP TABLE IF EXISTS AppsLCA.dbo.TB_Transfer_TablaKelly
    SELECT 
        dat.*
	...
	INTO AppsLCA.dbo.TB_Transfer_TablaKelly
    FROM [AppsLCA].[dbo].[ImportExport_DutyKellyGlobal_All2024_202511] AS DAT WITH(NOLOCK)
