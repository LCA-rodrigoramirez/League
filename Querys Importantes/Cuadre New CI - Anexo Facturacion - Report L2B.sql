    ...
    ---------------------INFORMACION FACTURACION-------------------------------------
        ...
        SELECT * INTO #TB_Dat_Invoice FROM(
         ...
         LEFT  JOIN (SELECT * FROM 
            ...
            LEFT JOIN [LCA].[dbo].[ManufactureOrders]   AS MO WITH(NOLOCK) ON AF.ManufactureID = MO.ManufactureID
...
SELECT * 
 ...
 FROM(
    SELECT 
        ...
        ,[Dif$_TotalPrice]       = S.[Total_Dat_Invoice] - (S.[Total_CI_CAFTA] + S.[Total_CI_NONCAFTA] + S.[Total_CI_9802])
