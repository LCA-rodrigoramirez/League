USE [LCA]
GO
/****** Object:  StoredProcedure [dbo].[InsertBillingDetails_Each]    Script Date: 24/06/2026 07:32:09 a. m. ******/
SET ANSI_NULLS ON
GO
...
DECLARE @DateNewFreight AS DATE = '2026-08-01'
--Declare @VFecha date =    CONVERT(DATE, GETDATE() -4 ) 
--Declare @VFecha  date = '2024-07-01'
----Declare @VFecha2 date = '2024-05-31'

--  Declare @VWaybill varchar(200) = 'AIR-APP-20260623-1'-- 'AIR-BUND-20240820' --'AIR-BUND-20240621-NO CAFTA'  
