...
/****** Object:  View [dbo].[VW_InfoOrdersToPolyPM]    Script Date: 16/02/2026 11:59:27 a. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[SP_InfoOrdersToPolyPM_Emb_HW]
AS
BEGIN
	SET NOCOUNT ON;
...
TRUNCATE TABLE [AppsLCA].[dbo].[InfoOrdersToPolyPM_Emb_HW];

INSERT INTO [AppsLCA].[dbo].[InfoOrdersToPolyPM_Emb_HW]
SELECT *
FROM #TB_Final;
END
GO
